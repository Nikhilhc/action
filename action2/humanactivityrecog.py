...
train1_data = r'C:\Users\Windows\Documents\action\actionfolder\train'
validation1_data=r'C:\Users\Windows\Documents\action\actionfolder\val'
IMG_SIZE=160
IMG_SIZE1=120
LR = 1e-3
'''
...
model.fit_generator(
    train_generator,
    steps_per_epoch=10750// 12, #nb_train_samples//batch_size
    epochs=50,
